...
export default function BoolenCard({ value }) {
  ...
  return (
    <Root>
      <div
        ...
        className={`${value.color_} font-bold ${value.shadowB} relative text-white px-6 py-10 text-center  rounded-2xl box-shadow`}
      >
        {CorrectAns ? (
