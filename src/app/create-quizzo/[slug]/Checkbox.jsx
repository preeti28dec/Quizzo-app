...
export default function CheckboxCard({ value }) {
  ...
  return (
    <Root>
      <div
        ...
        className={`${value.color_} text-center font-bold ${value.shadowB} relative text-white px-4  rounded-lg py-4 box-shadow`}
      >
        {CorrectAns ? (
